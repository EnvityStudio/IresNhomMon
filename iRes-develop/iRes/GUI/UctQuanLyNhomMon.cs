...
namespace Title.GUI {
    public partial class UctQuanLyNhomMon : UserControl
    {
        ...
        //private void gridViewNhomMon(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        //{
        //    int[] selRows = ((GridView)gridControlNhomMon.MainView).GetSelectedRows();
        //    DataRowView selRow = (DataRowView)(((GridView)gridControlNhomMon.MainView).GetRow(selRows[0]));
        //    this.textEditMaNhom.Text = selRow["MaNhom"].ToString();
        //    this.textEditTenNhom.Text = selRow["TenNhom"].ToString();
        //    this.textEditTongSoMon.Text = selRow["TongSoMon"].ToString();
